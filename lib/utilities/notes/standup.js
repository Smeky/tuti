import { createPage, openPage, openPageByIdName, getBlockByTitle } from "./notion.js"
...
export default async () => {
    ...
    if (inCache.pageName === pageName) {
        ...
        const exists = await getBlockByTitle(process.env.TUTI_NOTES_STANDUP_PAGEID, pageName)
        ...
        if (!exists) {
            ...
            openPageByIdName(exists.id, pageName, process.env.TUTI_NOTES_STANDUP_CHROME_PROFILE)
        }
    }
}
